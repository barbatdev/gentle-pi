...
- Durable baseline: candidate parent `3087173f0dea80b6a90c0f2499760141a2be2713` until this candidate has a commit; no future commit hash is asserted.
...
3. Collect the G07 A/B/C decision; do not re-prompt #379/#354.
